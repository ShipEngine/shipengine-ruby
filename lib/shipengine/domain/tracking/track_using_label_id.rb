  ...
  module Domain
    class Tracking
      module TrackUsingLabelId
        ...
        class Event
          attr_reader :occurred_at, :carrier_occurred_at, :description, :city_locality, :state_province, :postal_code, :country_code, :company_name, :signer, :event_code

          def initialize(occurred_at:, carrier_occurred_at:, description:, city_locality:, state_province:, postal_code:, country_code:, company_name:, signer:, event_code:)
